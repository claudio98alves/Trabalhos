...
<c:choose>
    <c:when test="${session.select == 'music'}">
        <s:form action="edit">
            <s:select list="{'Title','Compositor','Duration','Genre'}" label="Atributo" name="text"></s:select>
    ...
    <c:when test="${session.select == 'album'}">
        <s:form action="edit">
            <s:select list="{'Title','Description'}" label="Atributo" name="text"></s:select>
            <s:textfield label="Value" name="value"/>
            <s:submit />
        </s:form>
    </c:when>
    <c:when test="${session.select == 'artist'}">
        <s:form action="edit">
            <s:select list="{'Title','Description'}" label="Atributo" name="text"></s:select>
            <s:textfield label="Value" name="value"/>
            <s:submit />
